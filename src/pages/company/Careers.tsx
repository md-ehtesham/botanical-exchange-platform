      ...
      <div className="container-wide py-16">
        <div className="mb-16 max-w-3xl">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <div className="bg-herb-50 p-5 rounded-lg">
        ...
        <div>
          <h2 className="text-2xl font-bold mb-6 text-herb-800">Open Positions</h2>
          <div className="grid gap-6">
            {openPositions.map(job => (
              <Card key={job.id} className="overflow-hidden border-l-4 border-l-herb-600">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold mb-2 text-herb-700">{job.title}</h3>
