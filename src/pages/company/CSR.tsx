  ...
  return (
    <PageLayout title="CSR Initiatives">
      ...
      <div className="container-wide py-16">
        ...
        <div className="mt-16">
          <h2 className="text-2xl font-bold mb-6 text-herb-800">Our CSR Initiatives</h2>
          <div className="space-y-8">
            <div className="bg-herb-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-herb-700">Farmer Training Programs</h3>
            ...
            <div className="bg-herb-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-herb-700">Educational Sponsorship</h3>
              <p className="text-gray-600 mb-4">
            ...
            <div className="bg-herb-50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-herb-700">Reforestation Projects</h3>
              <p className="text-gray-600 mb-4">
